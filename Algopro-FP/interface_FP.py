...
class GameUI(object):
    def __init__(self, ai):
        ...
        self.board = pygame.image.load(os.path.join("Algopro-FP","Assets", 'board.jpg')).convert()
        self.blackPiece = pygame.image.load(os.path.join("Algopro-FP","Assets", 'black_piece.png')).convert_alpha()
        self.whitePiece = pygame.image.load(os.path.join("Algopro-FP","Assets", 'white_piece.png')).convert_alpha()
        self.menuBoard = pygame.image.load(os.path.join("Algopro-FP","Assets", "menu_board.png")).convert_alpha()
        self.buttonSurf = pygame.image.load(os.path.join("Algopro-FP","Assets", "button.png")).convert_alpha()
